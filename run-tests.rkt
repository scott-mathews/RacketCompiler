...
;(interp-tests "uniquify" #f uniquify-pass interp-scheme "ex3" (range 1 15))
...
;(interp-tests "patch instructions" #f assign-homes-pass interp-scheme "r1" (range 1 15))
(compiler-tests "r1-compiler" #f r1-passes "r1" (range 1 15))
