...
;;; === R1 Tests === ;;;
;; Confirmed R3 ;;
;(interp-tests "partial evaluator" (typecheck-R3 '()) pe-arith-pass interp-scheme "r1" (range 1 41))
;(interp-tests "uniquify" (typecheck-R3 '()) uniquify-pass interp-scheme "r1" (range 1 41))
;(interp-tests "expose-allocation" (typecheck-R3 '()) expose-allocation-pass interp-scheme "r1" (range 1 41))

;; In Progress R3 ;;
(interp-tests "flatten" (typecheck-R3 '()) flatten-pass interp-scheme "r1" (range 1 24))
;(interp-tests "select instructions" (typecheck-R3 '()) select-instructions-pass interp-scheme "r1" (range 1 41))
;(interp-tests "allocate registers" (typecheck-R3 '()) allocate-registers-pass interp-scheme "r1" (range 1 41))
;(interp-tests "patch instructions" (typecheck-R3 '()) patch-instructions-pass interp-scheme "r1" (range 1 41))
;(compiler-tests "r1-compiler" (typecheck-R3 '()) r1-passes "r1" (range 1 41))
...
;(interp-tests "uniquify" (typecheck-R3 '()) uniquify-pass interp-scheme "r3" (range 1 36))
;(interp-tests "expose-allocation" (typecheck-R3 '()) expose-allocation-pass interp-scheme "r3" (range 1 36))
(interp-tests "flatten" (typecheck-R3 '()) flatten-pass interp-scheme "r3" (range 1 36))
